var origData = {
	...
	"fake-download": {
		...
		"opt-1": "Close the tab/popup",
		"opt-2": "Click the link <br>and download the software",
		"correct": 1,
	...
	"amazon-fraud": {
		"name": "Amazon Fraud Message",
		"title": "We have detected fraud on your amazon account!!",
		"desc": "We have suspended an order for an iPhone 12 pro, that was placed under your account. We detected it as a fraudulent charge, if you did indeed order this ignore this message, if you didn't order it please call up 1300-566-391 and a customer care member will be with you shortly to cancel the order and refund your $800.",
		"opt-1": "Close the tab/popup",
		"opt-2": "Ring the number and follow the instructions",
		"correct": 1,
		"feedback": "As online shopping becomes more and more popular this scam has become more preeminent. It claims to be an alert from a company such as Amazon or Ebay, etc. It says that they detected a fraudulent charge against your account, which is usually a product worth a lot of money, and in order to confirm the decline you must contact them to get a refund. If you see this kind of scam you should close the tab or popup and report the scam to <a href='https://www.scamwatch.gov.au/report-a-scam'>Scam Watch</a> or <a href='https://www.econsumer.gov/#crnt'>Econsumer</a> (if you are outside australia)."
	},
